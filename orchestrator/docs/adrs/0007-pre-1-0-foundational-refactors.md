...
Agents of Chaos is still before its 1.0 architecture baseline. The goal of the pre-1.0 phase is not API or implementation stability. The goal is to build a foundation that can last.
