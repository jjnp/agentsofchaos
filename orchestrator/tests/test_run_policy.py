...
from agentsofchaos_orchestrator.domain.enums import RunStatus, RuntimeKind
from agentsofchaos_orchestrator.domain.models import Run
from agentsofchaos_orchestrator.domain.run_policy import (
...
def test_run_lifecycle_rejects_terminal_transition() -> None:
    ...
    with pytest.raises(InvalidRunTransitionError):
        policy.start(build_run(RunStatus.SUCCEEDED), started_at=datetime.now(UTC))
