# Agents of Chaos Orchestrator v2

This directory is the **fresh-start Python implementation** of Agents of Chaos v2.

It intentionally supersedes the earlier Python rewrite attempt. This is the only sanctioned path for the v2 orchestrator.

## What v2 is

Agents of Chaos v2 is a **local-first daemon** for a browser-native graph of agent work.
