...
from agentsofchaos_orchestrator_v2.domain.enums import EventTopic, NodeKind, NodeStatus
from agentsofchaos_orchestrator_v2.domain.errors import (
    ProjectNotFoundError,
    RootNodeAlreadyExistsError,
)
from agentsofchaos_orchestrator_v2.domain.models import CodeSnapshot, ContextSnapshot, Node, Project
    ...
    async def create_root_node(self, project_id: UUID, title: str | None = None) -> Node:
        ...
        await self._events.record_and_publish(
            ...
            payload={
                ...
                "contextSnapshotId": str(persisted_context.id),
