...
This document defines how Agents of Chaos v2 integrates with agent runtimes.

## 1. Core rule

Agents of Chaos v2 owns the canonical:
- graph
- node lineage
- code snapshots
- context snapshots
...
> Agents of Chaos v2 owns the canonical graph, code snapshots, and context snapshots. Agent runtimes are pluggable execution backends that produce normalized provenance and child nodes.
