...
Agents of Chaos v2 is still before its first stable schema. The persistence model is evolving quickly as core concepts are clarified:
...
Until the 1.0 schema baseline, v2 will not maintain forward migrations for local development databases.
