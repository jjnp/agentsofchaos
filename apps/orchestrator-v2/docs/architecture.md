...
This document defines the intended architecture of Agents of Chaos v2.

It should be treated as the implementation reference until superseded by ADRs.

## 1. Scope

Agents of Chaos v2 is a **local-first daemon** that powers a browser-native graph of agent work.
...
```text
src/agentsofchaos_orchestrator_v2/
  api/
    app.py
    dependencies.py
    routes/
