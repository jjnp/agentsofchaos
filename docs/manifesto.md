# Agents of Chaos Manifesto

## Coding agents should not feel like amnesia in a chat box.

Agents of Chaos begins with a simple belief:
...
**Agents of Chaos embraces non-linearity as a first principle.**
...
Here, context is not hidden in transcripts, buried in tool logs, or left implicit in a model’s temporary memory.
...
Agents of Chaos is local-first because:
- speed matters
- ownership matters
